				...
				<ol>
					...
					<li>
						<Button
							...
							onClick={() => this.props.onNavTo({key: ScreenKey.MyFeed}, {method: NavMethod.ReplaceAll})}
					...
					<li>
						<Button
							...
							onClick={() => this.props.onNavTo({key: ScreenKey.Leaderboards, params: {view: LeaderboardsViewParams.Readers}}, {method: NavMethod.ReplaceAll,})}
