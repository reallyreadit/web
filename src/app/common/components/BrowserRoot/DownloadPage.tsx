...
const downloadPage = (props: Services) => (
	<div className="download-page_4u78ip">
		<HomeHero
			title="The best app for reading."
			description={"Get the app on your favorite devices"}
		/>
		<div className="download-options">
			<div className="options-set options-mobile">
				...
				{renderDownloadOption({title: 'Android', iconName: 'android', link: 'https://apps.apple.com/us/app/readup-social-reading/id1441825432', onOpenNewPlatformNotificationRequestDialog: props.onOpenNewPlatformNotificationRequestDialog})}
			</div>
			<div className="options-set options-desktop">
				...
				{renderDownloadOption({title: 'Windows', iconName: 'windows', link: 'https://apps.apple.com/us/app/readup-social-reading/id1441825432'})}
			</div>
		</div>
	</div>
);
