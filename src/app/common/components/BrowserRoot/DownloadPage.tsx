	...
	<div className="download-page_4u78ip">
		...
		<div className="download-options">
			...
			<div className="options-set options-desktop">
				...
				{renderDownloadOption({title: 'Windows', iconName: 'windows', link: 'https://static.readup.org/downloads/windows/ReadupSetup.exe', services: props})}
				{renderDownloadOption({title: 'Linux (.deb)', iconName: 'linux', link: 'https://static.readup.org/downloads/linux/latest', services: props})}
			</div>
		</div>
