...
import SaveIndicator, {
	State as SaveIndicatorState,
} from '../../../../common/components/SaveIndicator';
...
export default class DisplayPreferencesControl extends React.Component<
	Props,
	State
> {
	...
	private readonly _setTheme = (value: string) => {
		...
		this.props
			...
			.then(
				this._asyncTracker.addCallback((preference) => {
					this.setState({
	...
	constructor(props: Props) {
		super(props);
		this.state = {
			saveIndicatorState: props.preference
