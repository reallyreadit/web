...
export class TwitterVerificationDialog extends React.Component<Props> {
	...
	public render() {
		return (
			<Dialog onClose={this.props.onClose} title="Are you on Twitter?">
				<div className="twitter-verification-dialog_fy082z">
					<p>
						Tweet your Readup reader name @ReadupDotCom and we'll take it from
						there.
					</p>
					<AuthServiceButton
					...
					/>
					<p className="small">
						Most verifications are processed within 3 business days.
					</p>
					<Link className="small" onClick={this.props.onUseEmailVerification}>
						Get verified using email instead.
					</Link>
				</div>
			</Dialog>
		);
