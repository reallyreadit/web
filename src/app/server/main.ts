...
// handle redirects
server = server.get<{}, any, any, { token: string }>('/confirmEmail', (req, res) => {
	req.api
...
server = server.get<{}, any, any, { token: string }>('/resetPassword', (req, res) => {
...
server = server.get<{ id?: string }, any, any, { token?: string }>('/viewReply/:id?', (req, res) => {
...
server = server.get<{}, any, any, { installationId?: string }>('/extension/uninstall', (req, res, next) => {
...
// render the app
server = server.get<{}, any, any, { [appReferralQueryStringKey]?: string }>('/*', (req, res) => {
	// session id
