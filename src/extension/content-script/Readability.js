...
// rrit begin: import cloneNodeWithReference
...
Readability.prototype = {
  ...
  **/
  ...
  _setNodeTag: function (node, tag) {
    ...
    // rrit begin: maintain originalNode reference
    ...
    while (true) {
      ...
      **/
      ...
      if (textLength < this._charThreshold) {
        ...
        this._forEachNode(pageCache.childNodes, function (node) {
  ...
  **/
  ...
  parse: function () {
    ...
    return {
      ...
      // rrit begin: return articleContent element
...
// rrit begin: typescript-compatible export
