...
(async () => {
	console.log('loading server api');
	// server
	...
	console.log('loading reader content script api');
	...
	console.log('loading web app api');
	// web app
	...
	await serverApi.initializeAsyncStores();
	await webAppApi.initializeAsyncStores();
	...
	chrome.runtime.onInstalled.addListener(async (details) => {
		...
		[
			window.reallyreadit.extension.config.cookieName,
			sessionIdCookieKey,
		].forEach((cookieName) => {
			chrome.cookies.get(
				{
