...
export default class Button extends React.PureComponent<Props> {
	public static defaultProps: Pick<
		Props,
		'align' | 'display' | 'hrefPreventDefault'
	> = {
		align: 'left',
		display: 'inline',
	...
	public render() {
		...
		switch (this.props.state) {
			case 'busy':
				overlayChild = <SpinnerIcon />;
				break;
			case 'set':
				overlayChild = <Icon name="checkmark" />;
				break;
		}
		...
		const sharedProps = {
			children: (
				<>
					{this.props.iconLeft ? (
						<Icon badge={badgeCount} name={this.props.iconLeft} />
					) : null}
					<span className="text">
						{this.props.text}
						{badgeCount && !this.props.iconLeft && !this.props.iconRight ? (
					...
					{this.props.iconRight ? (
						<Icon badge={badgeCount} name={this.props.iconRight} />
					) : null}
					{overlayChild ? (
						<span className="overlay">{overlayChild}</span>
					) : null}
				</>
			),
		...
		if (this.props.href) {
			return <a {...{ ...sharedProps, href: this.props.href }} />;
		}
